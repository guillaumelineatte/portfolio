  ...
  const projects = [
    {
      ...
      description: "Short description of the project. Replace with your actual project details.",
          ...
          <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
            ...
            >
              ...
              <p className="text-xl text-white/70 mb-10 max-w-2xl mx-auto">
                Crafting digital experiences with code. Passionate about building elegant solutions to complex problems.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="space-y-4 text-white/70">
                  ...
                  Après avoir validé un BTS Services informatiques aux organisations, je suis désormais à la recherche d'une entreprise
                  afin de continuer mon parcours en développement informatique et réaliser une licence professionnelle en alternance. Je suis disponible dès maintenant
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                ...
                <form className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    onClick={(e: React.MouseEvent<HTMLButtonElement>) => {
                      ...
                      window.location.href = `mailto:lineatteguillaume@gmail.com?subject=${encodeURIComponent(
                      mailtoLink.subject,
              ...
              <div className="grid gap-6">
                <motion.a
                  href="mailto:lineatteguillaume@gmail.com"
                  initial={{ opacity: 0, x: 20 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">lineatteguillaume@gmail.com</p>
                  </div>
                </motion.a>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-white/50 text-sm">
                © {new Date().getFullYear()} Guillaume Linéatte. All rights reserved.
              </p>
            </div>
